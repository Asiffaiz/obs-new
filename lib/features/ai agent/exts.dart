...
extension ParticipantAgentExt on sdk.Participant {
  ...
  sdk.AgentAttributes get agentAttributes =>
      sdk.AgentAttributes.fromJson(attributes);
  sdk.AgentState? get agentState => agentAttributes.lkAgentState;
}

// Ext for RoomContext
extension RoomContextAgentExt on lk_components.RoomContext {
  sdk.Participant? get agentParticipant =>
      participants.where((p) => p.isAgent).firstOrNull;
}
