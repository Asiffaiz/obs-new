  ...
  Widget build(BuildContext context) => AgentParticipantSelector(
    builder:
        (
          ...
          builder:
              (ctx, mediaTrack, child) => ChangeNotifierProvider<
                components.TrackReferenceContext?
              >.value(
                value:
...
//   const FrontView({super.key, required this.screenState});

//   @override
//   Widget build(BuildContext context) => components.MediaDeviceContextBuilder(
//     builder:
//         (context, roomCtx, mediaDeviceCtx) => Row(
//           spacing: 20,
...
//                   opacity:
//                       (screenState == AgentScreenState.transcription &&
//                               mediaDeviceCtx.cameraOpened)
//                           ? 1.0
//                           : 0.0,
...
//                       builder:
//                           (context, identifier) => components.VideoTrackWidget(
...
//           ),
//       builder:
//           (ctx, agentLayoutState, child) => AgentLayoutSwitcher(
...
//                     builder:
//                         (context, roomCtx, mediaDeviceCtx) =>
//                             components.ParticipantSelector(
//                               filter:
//                                   (identifier) =>
//                                       identifier.isVideo && identifier.isLocal,
//                               builder:
//                                   (context, identifier) => Stack(
//                                     children: [
...
//                         onTap:
//                             () =>
//                                 ctx.read<AppCtrl>().messageFocusNode.unfocus(),
