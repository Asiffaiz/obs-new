...
import 'package:voicealerts_obs/features/ai%20agent/widgets/floating_glass_circle.dart';
      ...
      children: [
        Expanded(
          ...
          child: components.MediaDeviceContextBuilder(
            builder:
                (context, roomCtx, mediaDeviceCtx) => Column(
                  children: [
                    FloatingGlassCircleButton(
                      ...
                      //   builder:
                      //       (context, identifier) => const SizedBox(
                      //         width: 15,
                      //         height: 15,
                    ...
                    SizedBox(height: 4),
                    Text(
                      mediaDeviceCtx.microphoneOpened ? 'Unmute' : 'Mute',
                      style: TextStyle(
                        fontSize: 12,
        ...
        //   child: components.MediaDeviceContextBuilder(
        //     builder:
        //         (context, roomCtx, mediaDeviceCtx) => FloatingGlassButton(
        //           sfIcon:
        ...
        //   builder:
        //       (context, agentScreenState, child) => Flexible(
        //         flex: 1,
        //         fit: FlexFit.tight,
        //         child: FloatingGlassButton(
        //           isActive:
        ...
        Expanded(
          ...
          child: Column(
            children: [
              FloatingGlassCircleButton(
                sfIcon:
                    ctx.read<AppCtrl>().isHoldEnabled
                        ? sf.SFIcons.sf_pause_fill
                        : sf.SFIcons.sf_play_fill,
                onTap: () => ctx.read<AppCtrl>().toggleHold(),
              ),
              SizedBox(height: 4),
              Text(
                'Hold',
