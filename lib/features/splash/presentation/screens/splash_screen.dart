  ...
  void _proceedWithNavigation(BuildContext context, AuthState state) async {
    ...
    if (!onboardingComplete && mounted) {
      ...
      if (isAuthenticated) {
        ...
        // Navigate based on agreements status
        if (mounted) {
          // Check if user should see onboarding or go to dashboard
          // For now, check agreements. You can add onboarding completion check here
